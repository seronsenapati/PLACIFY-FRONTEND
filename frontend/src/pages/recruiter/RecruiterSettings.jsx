  ...
  return (
    <div className="min-h-[calc(100vh-6rem)] flex justify-center items-start">
      <div className="w-full max-w-1xl mx-auto p-3 bg-black/20 rounded-lg min-h-[calc(100vh-8rem)]">
        ...
        <div className="flex flex-wrap gap-2 mb-4 p-1 bg-white/5 rounded-lg border border-white/10 w-full">
          <button
            onClick={() => setActiveTab("general")}
            className={`py-3 px-4 sm:px-6 font-semibold rounded-lg transition-all duration-200 flex items-center gap-2 flex-1 min-w-[120px] justify-center ${
              activeTab === "general"
          ...
          >
            ...
            <span className="hidden xs:inline">Job Defaults</span>
